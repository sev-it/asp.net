...
<head runat="server">
    <title>SilverlightPanoram</title>
    <style type="text/css">
    html, body {
	    height: 100%;
	    overflow: auto;
...
<body>
    ...
    <div id="silverlightControlHost">
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">
		  <param name="source" value="ClientBin/SilverlightPanoram.xap"/>
        ...
        <iframe id="htmlcontentIFrame" src="SilverlightPanoramTestPage.html" style="position:absolute; visibility: hidden; height: 0px; width: 0px;
